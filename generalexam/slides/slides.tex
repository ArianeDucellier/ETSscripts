...
\begin{document}
	...
	\begin{frame}
		...
		\begin{center}
			\includegraphics[width=8cm, trim={1cm 0cm 1cm 14cm}, clip]{longrange/cascadia_d.eps}
		\end{center}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{center}
			\includegraphics[width=7cm, trim={1cm 0cm 2cm 13cm}, clip]{longrange/guerrero_d.eps}
		\end{center}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{center}
			\includegraphics[width=7cm, trim={1cm 0cm 3cm 13cm}, clip]{longrange/sanandreas_d.eps}
		\end{center}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\item Quantification of uncertainty on the value of the fractional index
		\end{itemize}
	\end{frame}
	...
	\begin{frame}
		...
		\end{itemize}
		$\rightarrow$ What can we do when tremor is not correlated with slow slip?
	\end{frame}

...
\begin{document}
	...
	\begin{frame}
		...
		\begin{center}
			\includegraphics[width=10cm, trim={1cm 3cm 1cm 14cm}, clip]{longrange/cascadia_d.eps}
		\end{center}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{center}
			\includegraphics[width=8cm, trim={1cm 3cm 2cm 13cm}, clip]{longrange/guerrero_d.eps}
		\end{center}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{center}
			\includegraphics[width=8cm, trim={1cm 3cm 3cm 13cm}, clip]{longrange/sanandreas_d.eps}
		\end{center}
	\end{frame}

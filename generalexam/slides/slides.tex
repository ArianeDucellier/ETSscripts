...
\begin{document}
	...
	\begin{frame}
		...
		\begin{columns}[c]
			...
			\begin{column}{8cm}
				\begin{center}
				\includegraphics[trim={7cm 0cm 0cm 0cm}, clip, width=8cm]{subductionzone/subduction_0.eps}
			\end{center}
			\end{column}
		\end{columns}
	\end{frame}
	...
	\begin{frame}
		\frametitle{Summary of signal processing}
		\begin{tikzpicture}
			\node[align=center, draw, rectangle, fill=skyblue] (l1) {Time window \\ $\downarrow$ \\ Stack over stations};
			\node[below=0.5cm of l1] (l2) [align=center, draw, rectangle, fill=skyblue] {Time window \\ $\downarrow$ \\ Stack over stations};
			\node[below=0.5cm of l2] (l3) [align=center, draw, rectangle, fill=skyblue] {Time window \\ $\downarrow$ \\ Stack over stations};
			\node[right=3.5cm of l2] (r1) [align=center, draw, rectangle, fill=skyblue] {Stack over time windows \\ $\downarrow$ \\ Time lag of \\ maximum \\ cross-correlation};
			\path[draw,->, line width=1pt] (l1.east) -- node[above] {} (r1.west);
			\path[draw,->, line width=1pt] (l2.east) -- node[below] {} (r1.west);
			\path[draw,->, line width=1pt] (l3.east) -- node[below] {} (r1.west);
		\end{tikzpicture}
	\end{frame}
...
%		\begin{center}
%			\includegraphics[width=7cm, trim={0cm 0cm 0cm 0cm}, clip]{raypaths/tremor_disp.eps}
%		\end{center}
%	\end{frame}
...
%
	...
	\begin{frame}
		...
		\begin{columns}[c]
			...
			\begin{column}{5cm}
			\begin{center}
				\includegraphics[trim={4cm 5cm 3cm 9cm}, clip, width=3cm]{../slowslip/CKID/CKID_e_C6_DS.eps}
			\end{center}
			\end{column}
		\end{columns}
	\end{frame}

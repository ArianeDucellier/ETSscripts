...
\begin{itemize}
	...
	\item Read paper by Korenaga
	\item Implementation tf-PHS stacking
	\item Implementation noise computation (from Korenaga paper)
	\item Scripts to download and store tremor data
	\item Script to compute MODW(P)T and scattering transform (and then CC)
\end{itemize}

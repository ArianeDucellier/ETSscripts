...
tbegin = datetime(2017, 3, 1, 0, 0, 0)
tend = datetime(2017, 7, 1, 0, 0, 0)
...
df = pickle.load(open('/Users/ariane/Documents/Travail/ETSscripts/data/Ducellier/' + \
    filename + '/catalog_2017_03-06.pkl', 'rb'))
...
plt.xlabel('Time (days) since 2017/03/01', fontsize=24)
plt.ylabel('Number of LFEs', fontsize=24)
plt.title('Family {} ({:d} LFEs)'.format(filename, np.sum(X)), \
    fontsize=24)
plt.savefig('LFEdistribution/' + filename + '_2017_03-06.eps', format='eps')
plt.close(1)
